...
async function updateProject(req,res){
    if(req.method == 'PUT')
    {
        try{
            ...
            [req.body.project_title, req.body.project_description, req.body.project_language , req.body.project_priority , req.body.project_start , req.body.project_deadline , `${members}` , req.body.project_status, req.body.project_id ] );
