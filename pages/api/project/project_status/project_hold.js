...
async function projectStatus(req,res) {
    ...
    try{
        let projectStatus = await executeQuery("SELECT * FROM `tbl_project` WHERE project_status='On hold'  and `project_delete`='no' ORDER BY FIELD(`project_priority`,'high','medium','low')");
