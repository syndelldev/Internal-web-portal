...
function Dashboard({ project_details, User_name, allTask, userTask }) {
  ...
  const projectId = async (id) => {
    ...
    // console.log(id);
    var comment = await axios.post(`${server}/api/comment/userComments`, {
      task_id: id,
    });
  ...
  const updateProject = async () => {
    ...
    if (
      ...
      allMember == "" ||
      uoption.task_status == "" ||
      uoption.task_department == "" ||
      uoption.task_title == "" ||
      uoption.task_description == "" ||
      uoption.task_language == "" ||
      uoption.task_priority == "" ||
      startDate == "" ||
      endDate == ""
    ) {
      ...
      const res = await fetch(`${server}/api/subtask/update_subtask`, {
        ...
        body: JSON.stringify({
          task_id: uoption.task_id,
          project_name: u_project,
          task_person: allMember,
          task_status: uoption.task_status,
          task_department: uoption.task_department,
          task_title: uoption.task_title,
          task_description: uoption.task_description,
          task_language: uoption.task_language,
          task_comment: uoption.task_comment,
          task_priority: uoption.task_priority,
  ...
  const onSubmit = async (result) => {
    ...
    if (
      ...
      const res = await fetch(`${server}/api/subtask/add_subtask`, {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          task_person: selected,
          project_name: p_selected,
          task_status: result.task_status,
          task_title: result.task_title,
          task_description: result.task_description,
          task_language: result.task_language,
          task_comment: result.task_comment,
  ...
  const updateComment = async (id, comment) => {
    var comment = await axios.post(`${server}/api/comment/updateComment`, {
      comment_id: id,
      user: cookies.name,
      comment: comment,
    });
    ...
    <div>
            ...
            <Popup
              trigger={
                <div hidden={cookies.Role_id == "2"}>
                  <button className="bttn-design">Add Task</button>
                </div>
              }
      ...
      <div className="main_task_title">
        ...
        <button
          ...
          onClick={() => {
            taskToDo("task_toDo"),
              closeTaskToDo("task_toDo"),
              settodo_title(!todo_title),
              taskOnHold("taskOn_hold"),
              closeTaskOnHold("taskOn_hold"),
              setonhold_title(!onhold_title),
              taskRunning("task_Running"),
              closeTaskRunning("task_Running"),
        ...
        <Card>
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              ...
              >
                Task to do {taskTodo ? <FaArrowUp /> : <FaArrowDown />}{" "}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
                  ...
                  return (
                    <>
                      <tr
                        ...
                        onClick={() => {
                          toggle(task.task_id);
                          getData(task.task_id);
                          getTime(task.task_id);
                        }}
                      ...
                      >
                        ...
                        <td className="priority-data">
                          <p className={task.task_priority}>
                            {task.task_priority}
                          </p>
                        </td>
        ...
        <Card>
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              ...
              >
                Task on hold {TaskOnHold ? <FaArrowUp /> : <FaArrowDown />}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
        ...
        <Card>
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              ...
              >
                Task Running {TaskRunning ? <FaArrowUp /> : <FaArrowDown />}{" "}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
        ...
        <Card>
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              ...
              >
                Task completed {TaskCompleted ? <FaArrowUp /> : <FaArrowDown />}{" "}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
