...
function Dashboard({ User_name }) {
  ...
  const updateProject = async () => {
    ...
    if (
      uoption.project_title == "" ||
      uoption.project_description == "" ||
      uoption.project_department == "" ||
      uoption.project_language == "" ||
      allMember == "" ||
      startDate == "" ||
      endDate == "" ||
      uoption.project_priority == "" ||
      uoption.project_status == ""
    ) {
      ...
      const res = await fetch(`${server}/api/project/update_project`, {
        ...
        body: JSON.stringify({
          project_id: uoption.project_id,
          project_person: allMember,
          project_status: uoption.project_status,
          project_department: uoption.project_department,
          project_title: uoption.project_title,
          project_description: uoption.project_description,
          project_language: uoption.project_language,
          project_comment: uoption.project_comment,
          project_priority: uoption.project_priority,
  ...
  const onSubmit = async (result) => {
    ...
    if (result.project_title != "") {
      const res = await fetch(`${server}/api/project/addproject`, {
        ...
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          project_person: selected,
          project_department: result.project_department,
          project_status: result.project_status,
          project_title: result.project_title,
          project_description: result.project_description,
          project_language: result.project_language,
          project_comment: result.project_comment,
          project_priority: result.project_priority,
          project_start: p_start,
          project_deadline: p_end,
  ...
  const getData = async (project_id) => {
    var comment = await axios.post(`${server}/api/comment/getProjectComment`, {
  ...
  const sendMessage = async (project_id) => {
    ...
    var addComment = await axios.post(
      `${server}/api/comment/addProjectComments`,
      {
  ...
  const updateComment = async (id, comment) => {
    ...
    console.log(comment);
    console.log(id);
    var comments = await axios.post(`${server}/api/comment/updateComment`, {
      comment_id: id,
      user: cookies.name,
      comment: comment,
    });
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="error-msg">
                                    {errors.project_department && (
                                      <span>
                                        {errors.project_department.message}
                                      </span>
                                    )}
                                  </div>
                                </div>
                              ...
                              <GridItem xs={12} sm={12} md={6}>
                                <div className="form-group">
                                  ...
                                  <select
                                    ...
                                    id="Project_created_by"
                                    className="form-control signup-input"
                                    {...register("project_language", {
                                      required: true,
                                      message:
                                        "Please select atleast one option",
                                    })}
                                  ...
                                  <div className="error-msg">
                                    {errors.project_language && (
                                      <span>
                                        {errors.project_language.message}
                                      </span>
                                    )}
                                  </div>
                                </div>
                                ...
                                <div className="form-group">
                                  ...
                                  <div className="error-msg">
                                    {errors.project_priority && (
                                      <span>
                                        {errors.project_priority.message}
                                      </span>
                                    )}
                                  </div>
                                </div>
                            ...
                            <GridContainer>
                              <GridItem xs={12} sm={12} md={12}>
                                ...
                                >
                                  ...
                                  />
                                  <div className="error-msg">
                                    {errors.project_person && (
                                      <span>
                                        {errors.project_person.message}
                                      </span>
                                    )}
                                  </div>
                                </div>
          ...
          <GridItem>
            <div className="department_dropdown">
              ...
              <div className="department-link">
                ...
                <a href={`${server}/project_department/Web development`}>
                  Web Developer
                </a>
                <a href={`${server}/project_department/Content writer`}>
                  Content Writer
                </a>
                <a href={`${server}/project_department/Project manager`}>
                  Project Manager
                </a>
                <a href={`${server}/project_department/Mobile App developer`}>
                  Mobile App Developer
                </a>
            ...
            <GridItem>
              <button
                ...
                onClick={() => {
                  project_running("running"),
                    closeOnHold("running"),
                    setrunning_title(false),
                    project_OnHold("on hold"),
                    closeTaskToDo("on hold"),
                    setonhold_title(false);
                  project_Completed("completed"),
                    closeCompleted("completed"),
                    setcompleted_title(false);
                }}
              >
                Collapse All
              </button>
            ...
            <GridItem xs={12} sm={12} md={12}>
              <div
                onClick={() => {
                  project_running("running"),
                    closeOnHold("running"),
                    setrunning_title(!running_title);
                }}
                className="task_title"
              >
                {" "}
                Project In progress{" "}
                {running_title ? <FaArrowUp /> : <FaArrowDown />}{" "}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
                  ...
                  if (project.project_status == "running") {
                    ...
                    return (
                      <tr
                        ...
                        onClick={() => {
                          toggle(project.project_id);
                        }}
                        className="expand_dropdown"
                      >
                        <td className="project-title-table">
                          {project.project_title}
                        </td>
                        <td className="project-priority-table">
                          ...
                          {person.length > 2 ? (
                            ...
                            <span>
                              {person.map((user) => {
                                return (
                                  <div className="chip">
                                    <span className="members" title={user}>
                                      {user}
                                    </span>
                                  </div>
                                );
            ...
            <GridItem xs={12} sm={12} md={12}>
              <div
                onClick={() => {
                  project_OnHold("on hold"),
                    closeTaskToDo("on hold"),
                    setonhold_title(!onhold_title);
                }}
                className="task_title"
              >
                {" "}
                Project On Hold {onhold_title ? (
                  <FaArrowUp />
                ) : (
                  <FaArrowDown />
                )}{" "}
          ...
          <GridContainer>
            <GridItem xs={12} sm={12} md={12}>
              ...
              >
                {" "}
                Project Completed{" "}
                {completed_title ? <FaArrowUp /> : <FaArrowDown />}{" "}
              </div>
            </GridItem>
          </GridContainer>
        </Card>
